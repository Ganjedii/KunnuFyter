...
Welcome to **Kunnu fyter bot v2**! This is a powerful and customizable bot built for automating various tasks on Facebook Messenger.
...
1. **Clone the repository**:
    ```bash
    git clone https://github.com/Ganjedii/KunnuFyter.git
    ```
...
1. **fca-kunnu**
2. **kunnu-fca** (Recommended)

You can choose to use either of these options, but it's recommended to use **kunnu-fca** for the best performance and stability.
